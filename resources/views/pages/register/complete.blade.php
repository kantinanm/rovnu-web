                ...
                <div class="ui icon green message">
                    ...
                    <div class="content">
                        ...
                        <ul class="list">
                            ...
                            <li>ขั้นตอนต่อไป ทีมของคุณต้องกลับไปจัดทำ Clip Video แนะนำทีมและผู้เล่น พร้อมทั้ง Upload ลง Youtube , Facebook หรือ Platform อื่นๆ  </li>
                            <li>รายละเอียดการทำ Clip Video สามารถดูได้จาก <a href="{{$clip_video_url}}" target="_blank">ตัวอย่างการทำ Clip Video แนะนำทีม</a>   </li>
