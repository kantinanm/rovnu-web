            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="ui floating message">
                        ...
                        <h4 class="ui header">
                            <span class="markFont">เมื่อคุณลงทะเบียน </span>
                            <div class="sub header"><span class="markFont">เราจำเป็นต้องใช้บัญชีผู้ใช้งานและรหัสผ่านภายในเครือข่าย NU-NET ในการยืนยันตัวตน Authentication และดึงข้อมูลบางส่วนมากจาก  Active Directory ในระบบเครือข่ายมหาวิทยาลัย คุณไม่ต้องกังวลว่าว่าจะแอบดักจับรหัสผ่าน  และในการลงทะเบียนคุณจะใช้ข้อมูลจริง  เราจะใช้ชื่อของคุณเพื่อช่วยในการยืนยันบัญชีของคุณ เมื่อคุณโทรติดต่อฝ่ายจัดกิจกรรมการแข่งขันครั้งนี้</span></div>
                        </h4>
                        <p></p>
                        <h4 class="ui header">
...
ใช้ในการตรวจสอบกับทาง Garana Thailand เท่านั้น  ทางผู้จัดงานไม่มีนโยบายเปิดเผยข้อมูลส่วนตัว </span></div>
                        ...
                        <h4 class="ui header">
                            ...
                            <div class="sub header"><span class="markFont">ทางผู้จัดงานจำเป็นต้องเปิดเผยข้อมูลบางส่วน เพื่อให้การจัดการแข่งขันเป็นไปด้วยความเรียบร้อย  </span></div>
                        </h4>
