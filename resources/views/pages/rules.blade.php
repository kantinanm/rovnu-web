            ...
            <div class="row">
                ...
                <div class="feature-wiget">
                    <div class="content">
                        ...
                        <ol>
                            <li><p>รับสมัครทั้งหมด 64 ทีม แบ่งเป็นนิสิตของมหาวิทยาลัยนเรศวร ไม่จำกัดคณะ จำนวน 40 ทีม นิสิตของมหาวิทยาลัยราชภัฏพิบูลสงคราม จำนวน 6 ทีม โรงเรียนภายในจังหวัดพิษณุโลกและจังหวัดใกล้เคียงที่ได้หนังสือรับเชิญ (จำกัดเฉพาะระดับชั้นมัธยมศึกษาปีที่ 1 – 6 ) จำนวน 18 ทีม สมาชิกในแต่ละทีมต้องมาจากสถาบันเดียวกัน</p></li>
                            ...
                            <li><p>สามารถสมัครได้ที่เมนูสมัครเข้าร้วมแข่งขัน โดยให้หัวหน้าทีมเป็นผู้ทำสมัคร ดูคลิปวิดีโอตัวอย่างการสมัครได้ที่ ...</p></li>
                            <li><p>เมื่อทำการสมัครแล้วทุกทีมต้องส่งคลิปแนะนำตัวสมาชิกแต่ละคนในทีม (รวมผู้เล่นสำรอง 2 คนด้วย) ความยาวคลิปไม่เกิน 2 นาที สามารถดูตัวอย่างคลิปแนะนำตัวได้ที่ ... เพื่อให้ทีมงานสามารถตรวจสอบตัวตันผู้เล่นได้ คลิปที่แนะนำตัวจะมีการเผยแพร่เพื่อเปิดให้มีการ Vote ทีมในดวงใจ 1 ทีม ลุ้นรับของรางวัลพิเศษจากทีมงาน (สามารถอัพโหลดคลิปแนะนำตัวภายหลังการสมัครได้ แต่ต้องไม่เกินระยะเวลาที่กำหนด คือวันที่ 30 มิถุนายน 2561)</p></li>
                            <li><p>ผู้เล่นทุกคนควรปฏิบัติตามกติกาอย่างเคร่งครัด</p></li>
                        ...
                        <p>*ฟรีค่าสมัคร&nbsp;&nbsp;เปิดรับสมัครตั้งแต่วันที่ 1 – 30 มิถุนายน 2561 เวลา 23:59 น.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="feature-wiget">
                    <div class="content">
                        ...
                        <ol>
                            <li><p>หัวหน้าทีมของทั้งสองทีมต้องติดตามและค้นหาโพสเวลานัดเวลาแข่งขันทางเพจ ที่ทีมงานเป็นผู้จัดให้ ซึ่งทีมงานจะโพสก่อนวันแข่งขันล่วงหน้าอย่างน้อย 1 วัน</p></li>
                            <li><p>ผู้เล่นทั้งสองทีมต้องนัดเวลาการแข่งขันให้เรียบร้อยก่อน 18:00 น. ของวันที่แข่งขัน โดยต้องทำการนัดเวลาที่โพสที่กำหนดเท่านั้น</p></li>
                            <li><p>ทีมที่มีชื่อเป็นทีมแรก เช่น A Vs B ทีม A จะได้รับสิทธิ์คอมเม้นเพื่อนัดเวลาแข่งก่อน จากนั้นทีม B จะต้องเข้าไปค้นหาและตกลงเวลาในคอมเม้นของทีม A โดยการตอบกลับคอมเม้นเดิมที่ทีม A พิมพ์ไว้</p></li>
                ...
                <div class="feature-wiget">
                    <div class="content">
                        ...
                        <ol>
                            <li><p>ในกรณีที่มีผู้เล่นหลุดจากเกม ให้ทำการหยุดเกมชั่วคราว โดยแต่ละทีมสามารถกดหยุดเกมได้ทีมละ 5 ครั้ง ครั้งละไม่เกิน 1 นาที ถ้าหากเกินเวลาดังกล่าว อีกทีมสามารถกด Resume ได้ทันที และทำการแข่งขันต่อตามปกติ</p></li>
    ...
    <section id="rule4">
        <div class="container">
            <div class="row">
                <div class="feature-wiget">
                    <div class="content">
                        <h4 class="bottom-line"><i class="ion-ios-game-controller-a"></i>&nbsp;&nbsp;<span class="markFont">การแจ้งเหตุความไม่เป็นธรรมระหว่างการแข่งขัน</span></h4>
                        <ol>
