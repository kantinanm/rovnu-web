    ...
    <section id="formUI" class="newsletter">
                ...
                <div class="feature-wiget">
                    <div class="content">
                        ...
                        <ol>
                            ...
                            <li><p>ต้องเป็นผู้เล่น ROV ในเซิร์ฟเวอร์ไทยเท่านั้น</p></li>
                            ...
                            <li id="4"><p>สามารถสมัครได้ที่เมนู<a href="#" data-toggle="modal" data-target="#exampleModalCenter">สมัครเข้าร้วมแข่งขัน</a> โดยให้หัวหน้าทีมเป็นผู้ทำสมัคร ดูคลิปวิดีโอตัวอย่างการสมัครได้ที่ <a href="#">URL...</a></p></li>
                            <li id="5"><p>
                                    <div class="ui yellow message">
                                        <div class="header">
                                            <span class="markFont">ทุกทีมต้องส่งคลิปแนะนำตัวสมาชิกแต่ละคนในทีม</span>
                                        </div>
                                <p>เมื่อทำการสมัครแล้วทุกทีมต้องส่งคลิปแนะนำตัวสมาชิกแต่ละคนในทีม (รวมผู้เล่นสำรอง 2 คนด้วย) ความยาวคลิปไม่เกิน 2 นาที สามารถดูตัวอย่างคลิปแนะนำตัวได้ที่ <a href="#">URL...</a> เพื่อให้ทีมงานสามารถตรวจสอบตัวตันผู้เล่นได้ คลิปที่แนะนำตัวจะมีการเผยแพร่เพื่อเปิดให้มีการ Vote ทีมในดวงใจ 1 ทีม ลุ้นรับของรางวัลพิเศษจากทีมงาน (สามารถอัพโหลดคลิปแนะนำตัวภายหลังการสมัครได้ แต่ต้องไม่เกินระยะเวลาที่กำหนด คือวันที่ 30 มิถุนายน 2561)</p>
                    </div>
                    </p></li>
            ...
            <div class="feature-wiget">
                <div class="content">
                    ...
                    <ol>
                        ...
                        <li ><p>ทีมงานขอสงวนสิทธิ์ในการปรับเปลี่ยนกฎกติกาได้โดยไม่ต้องแจ้งให้ทราบล่วงหน้า</p></li>
                        <li><p>คำตัดสินของคณะกรรมการถือเป็นที่สิ้นสุด</p></li>
                        <li><p>แข่งขัน ณ ห้อง slope CE 4 ชั้น 7 อาคารวิศวกรรมโยธา คณะวิศวกรรมศาสตร์ มหาวิทยาลัยนเรศวร</p></li>
                    </ol>
        ...
        <div class="feature-wiget">
            <div class="content">
                ...
                <ol>
                    ...
                    <li><p>ในการนัดแข่งนั้น หาดทีมไหนมีผู้เล่นที่ใช้ Guest ID ในการเล่น หรือไม่ได้ผูกบัญชีไว้กับ Garena หรือ Facebook ทางทีมนั้นต้องแจ้งชื่อผู้เล่นที่จะลงแข่งในเกมไว้ในโพสนัดแข่งเพื่อป้องกันความสับสนที่อาจจะเกิดขึ้นในภายหลัง</p></li>
        ...
        <div class="feature-wiget">
            <div class="content">
                ...
                <ol>
                    ...
                    <li><p>ในกรณีที่ยังไม่มีการ First Blood และเวลาในเกมยังไม่เกิน 2 นาที ทีมที่ผู้เล่นหลุดสามารถแจ้งอีกทีมหนึ่งเพื่อขอรีแมทซ์ได้ทันที (บันทึกภาพไว้เป็นหลักฐานว่าหลุดจริง) โดยทั้งสองทีมจะต้องเลือกฮีโร่แบบเดิมกับเกมที่ขอทำการรีแมทซ์</p></li>
        ...
        <div class="feature-wiget">
            <div class="content">
                ...
                <ol>
                    <li><p>ติดตามและค้นหาโพสรายงานผลซึ่งจะโพสก่อนเวลาแข่งขัน ในวันที่มีการแข่งขันกมนั้นๆ (ก่อน 18:00 น. ของวันแข่งขันเกมนั้นๆ )</p></li>
                    <li><p>ให้หัวหน้าทีมผู้ชนะในการแข่งขันนัดนั้นๆ คอมเม้นตามแบบฟอร์ม </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ทีม A vs ทีม B ผลการแข่งขัน ทีม ... ชนะ</p></li>
                    <li><p>ให้คอมเม้นรูปผลการแข่งขันโดยการตอบกลับคอมเม้นแรก (ในข้อ 2)</p></li>
        ...
        <div class="feature-wiget">
            <div class="content">
                ...
                <ol>
                    ...
                    <li><p>หากมีการพบบัคขณะทำการแข่งขันที่ก่อให้ประสบปัญหาสามารถหยุดเกมและทักท้วงและถ่ายรูปส่งมาให้กรรมการตัดสินได้</p></li>
        ...
        <div class="feature-wiget">
            <div class="content">
                ...
                <ol>
                    <li><p>บันทึกหลักฐานเหตุการณ์ดังกล่าว เช่น รูปภาพ,คลิปวิดีโอ</p></li>
