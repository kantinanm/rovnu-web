<section id="introduction" class="gradient-violat padding-top-90 home-slider">
    <div id="home-slider" class="owl-carousel">
        <div>
            <div class="sliding-card-with-bottom-image text-center padding-top-90">
                ...
                <div class="cta-btn-group">
                    ...
                    <a class="btn-video text-white" href="https://youtu.be/yFDBWau2awc" target="_blank"><span class="icon-rounded bordered-ios"><i class="ion-ios-play-outline"></i></span>watch teaser</a>
                </div>
        ...
        <div>
            <div class="container">
                <div class="row">
                    <div class="image-right-slide-bg clearfix" style="background-image:url({{ URL::asset('images/banner03.png') }})">
                        <div class="col-md-12">
