<section id="testimonial" class="testimonial-section padding-top-bottom-90 gradient-violat">
    <div class="container">
        <div class="heading-wraper text-center">
            <h4 class="text-white">" วิวาทะ " จากทีมผู้เข้าแข่งขัน</h4>
                    ...
                    <div>
                        <div class="testimonial-container">
                            <div class="client-details text-center">
                                <img src="{{ URL::asset('images/Wan.png') }}" alt="">
                            ...
                            <div class="testimonial-content">
                                ...
                                <p class="testimonial-speech"><span class="markFont">E-Sport ไม่ใช่แค่การเล่นเกมอย่างเดียว แต่เป็นการแข่งขัน ได้ฝึกสมอง ฝึกการวางแผน และใช้เวลาว่างให้เป็นประโยชน์</span></p>
                            </div>
                        </div>
                    </div>
