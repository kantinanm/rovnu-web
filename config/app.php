...
return [
    ...
    */
    ...
    'how_to_register_url'=> env('HOW_TO_REGISTER_URL', 'https://www.youtube.com/watch?v=BXBurSbShYk&feature=youtu.be'),
    'how_to_register_manual'=> env('HOW_TO_REGISTER_MANUAL', 'https://goo.gl/iJkFXw'),
